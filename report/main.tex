...
\begin{center}
    ...
    \textbf{\huge (MI3090)} \\
    \vspace{9pt}
    \textbf{\huge Đề tài: Xây dựng Hệ thống gợi ý sản phẩm \\ (Recommendation System)} \\
    \vspace{18pt}
    \begin{flushleft}
\hspace*{2.3cm}
\begin{tabular}{p{5cm} p{7cm}}
Giảng viên hướng dẫn: & Lê Quang Hòa \\[0.4cm]

Mã lớp: & 169308 \\[0.4cm]

Nhóm sinh viên thực hiện: \\[0.4cm]

Đoàn Đức Anh & 202419033 \\[0.4cm]

Ngô Thị Thùy Duyên & 202419051 \\[0.4cm]

Nguyễn Đức Thành & 202419099 \\[0.4cm]

Phan Thị Hải Yến & 202419124 \\[0.4cm]
